...
def write_capture_md(
    ...
    *,
    ...
    lines = [
        ...
        "",
        "Agent: `read_file` every shot, score ok/ugly/broken, fix source,",
        "write `VISUAL_REPORT.md`. Full cut = shot pass + live pass.",
        "",
        "## Environment",
        "",
    ...
    lines.extend(
        [
            ...
            "6. Fix source (library first), re-capture, max 3 cycles per defect.",
            "7. `VISUAL_REPORT.md`: Environment, Shot table, Defects, Fix log,",
            "   Residual, Verdict (SHIP | POLISH | BLOCKED).",
