...
def write_capture_md(
    ...
    *,
    ...
    lines = [
        ...
        "",
        "Auto-generated by `gallery_walkthrough.py`. Agent: open every shot",
        "with `read_file`, score against `references/rubric.md`, write",
        "`VISUAL_REPORT.md` (ok / ugly / broken + one sentence).",
        "",
        "## Environment",
        "",
