...
const ROWS: &[(&str, &str, &str, &str, &str)] = &[
    ...
    ("job.motion", "Pick what opens and how it slides, then play.", "Chọn cái mở và cách trượt, rồi chạy.", "開くものとスライドを選んで再生。", "选打开什么、怎么滑，再播放。"),
    ...
    ("wjob.motion", "Dialog, menu, sheet, toast: fade and a short slide.", "Hộp thoại, trình đơn, tờ, thông báo: mờ và trượt ngắn.", "ダイアログ、メニュー、シート、トースト：フェードと短いスライド。", "对话框、菜单、页、吐司：淡入和短滑。"),
    ("wjob.switch-motion", "Replace one child with another. Shared axis is next/previous peers.", "Đổi một con bằng con khác. Trục chung là trước/sau cùng dãy.", "子を入れ替える。共有軸は前後の仲間。", "用另一个子项替换。共享轴是前后同伴。"),
    ("wjob.attention-motion", "Shake an invalid field. Pulse a live mark.", "Lắc trường sai. Nhịp dấu đang sống.", "無効な欄を揺らす。ライブ印をパルス。", "抖动无效字段。脉冲一个活动标记。"),
    ...
    ("host.switch-motion", "Switch motion", "Đổi chuyển động", "切替モーション", "切换动效"),
    ("host.attention-motion", "Attention motion", "Chuyển động chú ý", "注意モーション", "注意动效"),
    ...
    ("motion.when-enter", "Dialog, menu, sheet, toast: fade and a short slide.", "Hộp thoại, trình đơn, tờ, thông báo: mờ và trượt ngắn.", "ダイアログ、メニュー、シート、トースト：フェードと短いスライド。", "对话框、菜单、页、吐司：淡入和短滑。"),
    ("motion.when-switch", "Tab body or settings group: fade through.", "Thân thẻ hoặc nhóm cài đặt: mờ qua.", "タブ本体や設定グループ：フェードスルー。", "标签正文或设置组：淡入淡出。"),
    ("motion.when-axis", "Next and previous peers: shared axis, 12 dp.", "Trước và sau cùng dãy: trục chung, 12 dp.", "前後の仲間：共有軸、12 dp。", "前后同伴：共享轴，12 dp。"),
    ("motion.when-shake", "Invalid field: shake, then rest.", "Trường sai: lắc rồi nghỉ.", "無効な欄：シェイクして止まる。", "无效字段：抖动后停下。"),
    ("motion.next", "Next", "Sau", "次", "下一个"),
    ("motion.previous", "Previous", "Trước", "前", "上一个"),
    ("motion.notes", "Notes", "Ghi chú", "メモ", "笔记"),
    ("motion.guide", "Guide", "Hướng dẫn", "ガイド", "指南"),
    ("motion.event-a", "Opened notes.txt", "Đã mở notes.txt", "notes.txt を開いた", "打开了 notes.txt"),
    ("motion.event-b", "Saved notes.txt", "Đã lưu notes.txt", "notes.txt を保存した", "保存了 notes.txt"),
    ("motion.check", "Check", "Kiểm", "確認", "检查"),
    ("motion.field", "Name", "Tên", "名前", "名称"),
    ("motion.field-ok", "Looks good.", "Ổn.", "問題なし。", "没问题。"),
    ("motion.field-bad", "Name is required.", "Cần tên.", "名前が必要です。", "需要名称。"),
    ("motion.kind", "Opens", "Mở", "開く", "打开"),
    ("motion.slide", "Slide", "Trượt", "スライド", "滑动"),
    ("motion.face", "Face", "Mặt", "面", "面"),
    ("motion.axis", "Axis", "Trục", "軸", "轴"),
    ("motion.enter", "Enter", "Vào", "入場", "进入"),
    ("motion.exit", "Exit", "Ra", "退場", "退出"),
    ("motion.ms", "Duration", "Thời lượng", "長さ", "时长"),
    ("motion.job", "Job", "Việc", "ジョブ", "作业"),
    ("motion.play", "Play", "Chạy", "再生", "播放"),
    ("motion.slide-dir-ltr", "Start is left in this window. End is right. Those edges flip when the window is right-to-left.", "Start là trái trong cửa sổ này. End là phải. Hai mép đảo khi cửa sổ phải-sang-trái.", "この窓では Start が左、End が右。右から左の窓では端が入れ替わる。", "本窗口里 Start 是左，End 是右。窗口从右到左时两边对调。"),
    ("motion.slide-dir-rtl", "Start is right in this window. End is left. Those edges flip when the window is left-to-right.", "Start là phải trong cửa sổ này. End là trái. Hai mép đảo khi cửa sổ trái-sang-phải.", "この窓では Start が右、End が左。左から右の窓では端が入れ替わる。", "本窗口里 Start 是右，End 是左。窗口从左到右时两边对调。"),
    ("motion.kind-dialog", "Dialog", "Hộp thoại", "ダイアログ", "对话框"),
    ("motion.kind-menu", "Menu", "Trình đơn", "メニュー", "菜单"),
    ("motion.kind-sheet", "Sheet", "Tờ", "シート", "页"),
    ("motion.kind-toast", "Toast", "Thông báo", "トースト", "吐司"),
    ("motion.kind-tooltip", "Tooltip", "Chú giải", "ツールチップ", "提示"),
    ("motion.slide-none", "Fade only", "Chỉ mờ", "フェードのみ", "只淡入"),
    ("motion.slide-up", "Up", "Lên", "上", "上"),
    ("motion.slide-down", "Down", "Xuống", "下", "下"),
    ("motion.slide-start", "Start", "Đầu", "開始", "起始"),
    ("motion.slide-end", "End", "Cuối", "終端", "末端"),
    ("motion.face-through", "Fade through", "Mờ qua", "フェードスルー", "淡入淡出"),
    ("motion.face-axis", "Shared axis", "Trục chung", "共有軸", "共享轴"),
    ("motion.axis-block", "Height", "Cao", "高さ", "高度"),
    ("motion.axis-inline", "Width", "Rộng", "幅", "宽度"),
    ("motion.attn-shake", "Shake", "Lắc", "シェイク", "抖动"),
    ("motion.attn-pulse", "Pulse", "Nhịp", "パルス", "脉冲"),
    ("motion.uses-dialog", "A confirm sheet over the page.", "Tờ xác nhận trên trang.", "ページ上の確認シート。", "页上的确认页。"),
    ("motion.uses-menu", "A menu from a click.", "Trình đơn từ một cú nhấn.", "クリックから出るメニュー。", "点击后出现的菜单。"),
    ("motion.uses-sheet", "A properties pane from the edge.", "Ô thuộc tính từ mép.", "端から出るプロパティペイン。", "从边缘出来的属性栏。"),
    ("motion.uses-toast", "A short notice at the foot.", "Thông báo ngắn ở chân.", "足元の短い知らせ。", "脚上的短通知。"),
    ("motion.uses-tooltip", "A tip on a control.", "Chú giải trên điều khiển.", "コントロール上のヒント。", "控件上的提示。"),
    ("motion.uses-through", "Use for tab_view body and settings groups.", "Dùng cho thân tab_view và nhóm cài đặt.", "tab_view 本体と設定グループに使う。", "用于 tab_view 正文和设置组。"),
    ("motion.uses-axis-y", "Use for timeline next/previous and wizard steps.", "Dùng cho trước/sau dòng thời gian và bước wizard.", "タイムラインの前後とウィザード段に使う。", "用于时间线前后和向导步骤。"),
    ("motion.uses-axis-x", "Use for list-detail and breadcrumb drill.", "Dùng cho list-detail và breadcrumb.", "list-detail とパンくず掘りに使う。", "用于 list-detail 和面包屑下钻。"),
    ("motion.uses-block", "Use for expander, accordion, and tree.", "Dùng cho expander, accordion, và tree.", "expander、accordion、tree に使う。", "用于 expander、accordion 和 tree。"),
    ("motion.uses-inline", "Use for drawer and a folder rail.", "Dùng cho drawer và ray thư mục.", "drawer とフォルダレールに使う。", "用于 drawer 和文件夹栏。"),
    ("motion.uses-shake", "Use for an invalid field after a failed check.", "Dùng cho trường sai sau kiểm thất bại.", "検査失敗の後の無効欄に使う。", "用于检查失败后的无效字段。"),
    ("motion.uses-pulse", "Use for a live or recording mark.", "Dùng cho dấu đang sống hoặc ghi.", "ライブや録音の印に使う。", "用于活动或录制标记。"),
    ...
    ("md.hint", "Drag a range. Double-click a word, again for the sentence, again for the block. Ctrl+A selects all. Copy takes that text. Copy all posts the source.", "Kéo một đoạn. Nhấp đúp một từ, lần nữa cho câu, lần nữa cho khối. Ctrl+A chọn hết. Sao chép lấy chữ đó. Sao chép tất cả gửi nguồn.", "ドラッグで範囲。ダブルクリックは語、次は文、次はブロック。Ctrl+A で全部。コピーはその文。すべてコピーは原文。", "拖选一段。双击选词，再点选句，再点选块。Ctrl+A 全选。复制取那段文字。全部复制发送原文。"),
    ...
    ("switch.tail", "Tail", "Đuôi", "末尾", "尾随"),
    ("switch.raw", "Raw", "Thô", "生", "原始"),
...
const AR: &[(&str, &str)] = &[
    ...
    ("job.motion", "اختر ما يُفتح وكيف ينزلق ثم شغّل."),
    ...
    ("wjob.motion", "حوار وقائمة وورقة وتنبيه: تلاشٍ وانزلاق قصير."),
    ("wjob.switch-motion", "استبدل ابناً بآخر. المحور المشترك أقران التالي/السابق."),
    ("wjob.attention-motion", "هز حقلاً غير صالح. نبض علامة حية."),
    ...
    ("host.motion", "حركة"),
    ("host.switch-motion", "حركة التبديل"),
    ("host.attention-motion", "حركة الانتباه"),
    ...
    ("motion.when-enter", "حوار وقائمة وورقة وتنبيه: تلاشٍ وانزلاق قصير."),
    ("motion.when-switch", "جسم اللسان أو مجموعة الإعدادات: تلاشٍ عبر."),
    ("motion.when-axis", "الأقران التالي والسابق: محور مشترك، ١٢ نقطة."),
    ("motion.when-shake", "حقل غير صالح: اهتزاز ثم سكون."),
    ("motion.next", "التالي"),
    ("motion.previous", "السابق"),
    ("motion.notes", "ملاحظات"),
    ("motion.guide", "دليل"),
    ("motion.event-a", "فُتح notes.txt"),
    ("motion.event-b", "حُفظ notes.txt"),
    ("motion.check", "تحقق"),
    ("motion.field", "الاسم"),
    ("motion.field-ok", "جيد."),
    ("motion.field-bad", "الاسم مطلوب."),
    ("motion.kind", "يفتح"),
    ("motion.slide", "انزلاق"),
    ("motion.face", "وجه"),
    ("motion.axis", "محور"),
    ...
    ("motion.job", "المهمة"),
    ("motion.play", "تشغيل"),
    ("motion.slide-dir-ltr", "Start يسار في هذه النافذة. End يمين. الحافتان تنعكسان عندما تكون النافذة من اليمين لليسار."),
    ("motion.slide-dir-rtl", "Start يمين في هذه النافذة. End يسار. الحافتان تنعكسان عندما تكون النافذة من اليسار لليمين."),
    ("motion.kind-dialog", "حوار"),
    ("motion.kind-menu", "قائمة"),
    ("motion.kind-sheet", "ورقة"),
    ("motion.kind-toast", "تنبيه"),
    ("motion.kind-tooltip", "تلميح"),
    ("motion.slide-none", "تلاشٍ فقط"),
    ("motion.slide-up", "أعلى"),
    ("motion.slide-down", "أسفل"),
    ("motion.slide-start", "بداية"),
    ("motion.slide-end", "نهاية"),
    ("motion.face-through", "تلاشٍ عبر"),
    ("motion.face-axis", "محور مشترك"),
    ("motion.axis-block", "ارتفاع"),
    ("motion.axis-inline", "عرض"),
    ("motion.attn-shake", "اهتزاز"),
    ("motion.attn-pulse", "نبض"),
    ("motion.uses-dialog", "ورقة تأكيد فوق الصفحة."),
    ("motion.uses-menu", "قائمة من نقرة."),
    ("motion.uses-sheet", "لوحة خصائص من الحافة."),
    ("motion.uses-toast", "تنبيه قصير في القدم."),
    ("motion.uses-tooltip", "تلميح على عنصر."),
    ("motion.uses-through", "لجسم tab_view ومجموعات الإعدادات."),
    ("motion.uses-axis-y", "للتالي/السابق في الخط الزمني وخطوات المعالج."),
    ("motion.uses-axis-x", "لـ list-detail ومسار التنقل."),
    ("motion.uses-block", "لـ expander و accordion و tree."),
    ("motion.uses-inline", "لـ drawer وشريط المجلد."),
    ("motion.uses-shake", "لحقل غير صالح بعد فحص فاشل."),
    ("motion.uses-pulse", "لعلامة حية أو تسجيل."),
    ...
    ("md.hint", "اسحب نطاقاً. انقر نقراً مزدوجاً للكلمة، مرة أخرى للجملة، مرة أخرى للكتلة. Ctrl+A يحدد الكل. النسخ يأخذ ذلك النص. نسخ الكل يرسل المصدر."),
...
const UR: &[(&str, &str)] = &[
    ...
    ("job.motion", "کیا کھلے اور کیسے پھسلے چنیں، پھر چلائیں۔"),
    ...
    ("wjob.motion", "مکالمہ، مینو، ورق، اطلاع: مدھم اور چھوٹی پھسل۔"),
    ("wjob.switch-motion", "ایک بچے کو دوسرے سے بدلے۔ مشترکہ محور اگلا/پچھلا ساتھی ہے۔"),
    ("wjob.attention-motion", "غلط خانہ ہلائیں۔ زندہ نشان دھڑکائیں۔"),
    ...
    ("host.motion", "حرکت"),
    ("host.switch-motion", "بدل حرکت"),
    ("host.attention-motion", "توجہ حرکت"),
    ...
    ("motion.when-enter", "مکالمہ، مینو، ورق، اطلاع: مدھم اور چھوٹی پھسل۔"),
    ("motion.when-switch", "ٹیب کا جسم یا سیٹنگ گروپ: مدھم گزر۔"),
    ("motion.when-axis", "اگلا اور پچھلا ساتھی: مشترکہ محور، ١٢ dp۔"),
    ("motion.when-shake", "غلط خانہ: ہلاؤ، پھر آرام۔"),
    ("motion.next", "اگلا"),
    ("motion.previous", "پچھلا"),
    ("motion.notes", "نوٹس"),
    ("motion.guide", "رہنما"),
    ("motion.event-a", "notes.txt کھلا"),
    ("motion.event-b", "notes.txt محفوظ"),
    ("motion.check", "جانچیں"),
    ("motion.field", "نام"),
    ("motion.field-ok", "ٹھیک ہے۔"),
    ("motion.field-bad", "نام چاہیے۔"),
    ("motion.kind", "کھلتا"),
    ("motion.slide", "پھسل"),
    ("motion.face", "رخ"),
    ("motion.axis", "محور"),
    ...
    ("motion.job", "کام"),
    ("motion.play", "چلائیں"),
    ("motion.slide-dir-ltr", "اس کھڑکی میں Start بائیں ہے۔ End دائیں۔ کھڑکی دائیں سے بائیں ہو تو کنارے الٹ جاتے ہیں۔"),
    ("motion.slide-dir-rtl", "اس کھڑکی میں Start دائیں ہے۔ End بائیں۔ کھڑکی بائیں سے دائیں ہو تو کنارے الٹ جاتے ہیں۔"),
    ("motion.kind-dialog", "مکالمہ"),
    ("motion.kind-menu", "مینو"),
    ("motion.kind-sheet", "ورق"),
    ("motion.kind-toast", "اطلاع"),
    ("motion.kind-tooltip", "اشارہ"),
    ("motion.slide-none", "صرف مدھم"),
    ("motion.slide-up", "اوپر"),
    ("motion.slide-down", "نیچے"),
    ("motion.slide-start", "شروع"),
    ("motion.slide-end", "آخر"),
    ("motion.face-through", "مدھم گزر"),
    ("motion.face-axis", "مشترکہ محور"),
    ("motion.axis-block", "اونچائی"),
    ("motion.axis-inline", "چوڑائی"),
    ("motion.attn-shake", "ہلاؤ"),
    ("motion.attn-pulse", "نبض"),
    ("motion.uses-dialog", "صفحے پر تصدیقی ورق۔"),
    ("motion.uses-menu", "کلک سے مینو۔"),
    ("motion.uses-sheet", "کنارے سے خصوصیات کا خانہ۔"),
    ("motion.uses-toast", "پاؤں پر مختصر اطلاع۔"),
    ("motion.uses-tooltip", "کنٹرول پر اشارہ۔"),
    ("motion.uses-through", "tab_view کے جسم اور سیٹنگ گروپوں کے لیے۔"),
    ("motion.uses-axis-y", "ٹائم لائن اگلا/پچھلا اور وزرڈ قدموں کے لیے۔"),
    ("motion.uses-axis-x", "list-detail اور بریڈکرمب کے لیے۔"),
    ("motion.uses-block", "expander، accordion، اور tree کے لیے۔"),
    ("motion.uses-inline", "drawer اور فولڈر پٹی کے لیے۔"),
    ("motion.uses-shake", "ناکام جانچ کے بعد غلط خانے کے لیے۔"),
    ("motion.uses-pulse", "زندہ یا ریکارڈ نشان کے لیے۔"),
    ...
    ("md.hint", "ایک حد گھسیٹیں۔ لفظ پر دو بار دبائیں، پھر جملہ، پھر بلاک۔ Ctrl+A سب چنتا ہے۔ نقل وہ متن لیتی ہے۔ سب نقل ماخذ بھیجتی ہے۔"),
...
const HE: &[(&str, &str)] = &[
    ...
    ("job.motion", "בחרו מה נפתח ואיך זה מחליק, והפעילו."),
    ...
    ("wjob.motion", "דיאלוג, תפריט, גיליון, התראה: עמעום והחלקה קצרה."),
    ("wjob.switch-motion", "החלפת ילד בילד. ציר משותף הוא עמיתים הבא/קודם."),
    ("wjob.attention-motion", "רעד בשדה לא תקין. פעימה בסימן חי."),
    ...
    ("host.motion", "תנועה"),
    ("host.switch-motion", "תנועת החלפה"),
    ("host.attention-motion", "תנועת תשומת לב"),
    ...
    ("motion.when-enter", "דיאלוג, תפריט, גיליון, התראה: עמעום והחלקה קצרה."),
    ("motion.when-switch", "גוף לשונית או קבוצת הגדרות: עמעום דרך."),
    ("motion.when-axis", "עמיתים הבא וקודם: ציר משותף, 12 dp."),
    ("motion.when-shake", "שדה לא תקין: רעד ואז מנוחה."),
    ("motion.next", "הבא"),
    ("motion.previous", "הקודם"),
    ("motion.notes", "הערות"),
    ("motion.guide", "מדריך"),
    ("motion.event-a", "notes.txt נפתח"),
    ("motion.event-b", "notes.txt נשמר"),
    ("motion.check", "בדוק"),
    ("motion.field", "שם"),
    ("motion.field-ok", "נראה טוב."),
    ("motion.field-bad", "דרוש שם."),
    ("motion.kind", "נפתח"),
    ("motion.slide", "החלקה"),
    ("motion.face", "פנים"),
    ("motion.axis", "ציר"),
    ...
    ("motion.job", "משימה"),
    ("motion.play", "נגן"),
    ("motion.slide-dir-ltr", "Start הוא שמאל בחלון הזה. End הוא ימין. הקצוות מתהפכים כשהחלון מימין לשמאל."),
    ("motion.slide-dir-rtl", "Start הוא ימין בחלון הזה. End הוא שמאל. הקצוות מתהפכים כשהחלון משמאל לימין."),
    ("motion.kind-dialog", "דיאלוג"),
    ("motion.kind-menu", "תפריט"),
    ("motion.kind-sheet", "גיליון"),
    ("motion.kind-toast", "התראה"),
    ("motion.kind-tooltip", "טיפ"),
    ("motion.slide-none", "עמעום בלבד"),
    ("motion.slide-up", "למעלה"),
    ("motion.slide-down", "למטה"),
    ("motion.slide-start", "התחלה"),
    ("motion.slide-end", "סוף"),
    ("motion.face-through", "עמעום דרך"),
    ("motion.face-axis", "ציר משותף"),
    ("motion.axis-block", "גובה"),
    ("motion.axis-inline", "רוחב"),
    ("motion.attn-shake", "רעד"),
    ("motion.attn-pulse", "פעימה"),
    ("motion.uses-dialog", "גיליון אישור מעל הדף."),
    ("motion.uses-menu", "תפריט מלחיצה."),
    ("motion.uses-sheet", "לוח מאפיינים מהקצה."),
    ("motion.uses-toast", "הודעה קצרה בתחתית."),
    ("motion.uses-tooltip", "טיפ על פקד."),
    ("motion.uses-through", "עבור גוף tab_view וקבוצות הגדרות."),
    ("motion.uses-axis-y", "עבור הבא/קודם בציר הזמן ושלבי אשף."),
    ("motion.uses-axis-x", "עבור list-detail ופירורי לחם."),
    ("motion.uses-block", "עבור expander, accordion ו-tree."),
    ("motion.uses-inline", "עבור drawer ומסילת תיקיות."),
    ("motion.uses-shake", "עבור שדה לא תקין אחרי בדיקה שנכשלה."),
    ("motion.uses-pulse", "עבור סימן חי או הקלטה."),
    ...
    ("md.hint", "גררו טווח. לחצו פעמיים על מילה, שוב למשפט, שוב לבלוק. Ctrl+A בוחר הכול. העתקה לוקחת את הטקסט. העתק הכול שולח את המקור."),
